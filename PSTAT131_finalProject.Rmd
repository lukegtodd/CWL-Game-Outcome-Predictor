...
ggplot(all_snd_2019, aes(x = reorder(player, fb_avg), y = fb_avg)) + geom_boxplot() + coord_flip(ylim = c(0, 3)) + labs(y = "Firstblood Average", x = "Player", subtitle = "Player Firstblood Average for SEARCH AND DESTROY, 2019 Season (BO4), Descending")
...
ggplot(allMajors2019, aes(x = reorder(player, win), y = win)) + geom_bar() + coord_flip(ylim = c(0, 675)) + labs(y = "Number of wins", x = "Player", subtitle = "OVERALL Number of Wins, 2019 Season (BO4), Descending")
